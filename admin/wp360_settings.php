...
if(isset($_POST['wp360_submit']) && isset($_POST['_wpnonce_save_company_address']) && wp_verify_nonce($_POST['_wpnonce_save_company_address'], 'save-company-address-nonce')) {
    $allowed_html = array(
        'br' => array()
    );
        ...
        <form action="#" method="post" autocomplete="off">
            ...
            <table>
                <tr>
                    ...
                    <td><textarea type="text" name="wp360option[wp360_company_address]" class="regular-text"  rows="5"><?php echo esc_attr($saved_company_address); ?></textarea></td>
                </tr>
                <tr>
                    <th><?php esc_html_e('Thank you message:', 'wp360-invoice'); ?> </th>
                    <td><input type="text" name="wp360option[wp360_thankyoumsg]" value="<?php echo esc_attr($thankyoumsg); ?>" class="regular-text"/></td>
                </tr>
                <tr>
                    <th><?php esc_html_e('Invoice StartNumber:', 'wp360-invoice'); ?> </th>
                    <td><input type="text" name="wp360option[wp360_invoicestartnumber]" value="<?php echo esc_attr($wp360_invoicestartnumber); ?>" class="regular-text"/></td>
                </tr>
                <tr>
                    <th></th>
