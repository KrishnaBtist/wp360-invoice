...
&& wp_verify_nonce($_POST['_wpnonce_add_invoice'], 'add-invoice-nonce-action')
) {       
...
<div class="wp360-invoice-addInvoice">
    <form action="" method="post">
                ...
                <?php
                    ...
                    if ($customers && is_array($customers) && !empty($customers)) {
                        foreach ($customers as $key => $customerID) {
                            ...
                            $user_display_name = $customer->get_display_name();
                            echo '<option value="'.esc_attr($customerID).'">'.esc_attr($user_display_name).' ('.esc_attr($user_email).')'.'</option>';
                        }
                    }
                ?>
            </select>
        ...
        <div class="invoiceFormInn itemsCon">
            ...
            <div class="addInvoiceItemCon">
                <a href="javascript:;" class="addInvoiceItem"><?php esc_html_e('Add Item/Service', 'wp360-invoice'); ?></a>
                <a href="javascript:;" class="removeInvoiceItem" style="display:none"><?php esc_html_e('Remove Item/Service', 'wp360-invoice'); ?></a>
            </div>
        </div>
