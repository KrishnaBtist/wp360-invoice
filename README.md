...
3. Configure the plugin settings via the 'wp360 Invoice' menu in the WordPress admin.
...
4. Users can access their invoices through their my account dashboard under the 'Invoice' menu.
